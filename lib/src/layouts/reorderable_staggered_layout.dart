...
///
class ReorderableDraggableStaggeredLayout extends StatefulWidget {
  /// Creates a reorderable list.
  ReorderableDraggableStaggeredLayout({
    Key? key,
    this.header,
  ...
  @override
  _ReorderableDraggableStaggeredLayoutState createState() => _ReorderableDraggableStaggeredLayoutState();
}
...
class _ReorderableDraggableStaggeredLayoutState extends State<ReorderableDraggableStaggeredLayout> {
  @override
      ...
      initialEntries: <OverlayEntry>[
        OverlayEntry(
          ...
          builder: (BuildContext context) {
            return ReorderableStaggeredLayout(
              key: GlobalKey(debugLabel: '$ReorderableStaggeredLayout layout'),
